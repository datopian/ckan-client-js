...
class Client {
   ...
   * @param {string} id - Id or name of the package
   * @param {boolean} useDefaultSchema - Indicates whether to use default package schema instead of a custom schema defined with an IDatasetForm plugin (default: false)
   * @param {boolean} includeTracking - Indicates whether to add tracking information to dataset and resources (default: False)
   */
  async retrieve(id, useDefaultSchema = false, includeTracking = false) {
    ...
    const result = mapper.packageCkanToFrictionless(response.result)
